...
<section class="statistics">
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-info">
                <span class="stat-count" data-count="52">0</span>
...
<section id="help" class="help">
    ...
    <?php if (isset($_SESSION['contact_error'])): ?>
        <div class="alert error">
            <i class="fas fa-exclamation-circle"></i> <?php echo htmlspecialchars($_SESSION['contact_error']); ?>
        </div>
    ...
    <form action="contact.php" method="POST" class="contact-form">
        ...
        <textarea name="message" 
                  ...
                  rows="5" 
                  required 
                  aria-label="Your message"><?php echo isset($_SESSION['form_data']['message']) ? htmlspecialchars($_SESSION['form_data']['message']) : ''; ?></textarea>
...
<footer>
    ...
    <div class="footer-bottom">
        <p>&copy; <?php echo date('Y'); ?> Readify - All rights reserved</p>
    </div>
</footer>
